...
> **Last storm:** 2026-08-29 `/storm -realty` — `frontend-features.md`, `backend-features.md`, `api.md`, `mock.md`, `TODO.md`

DeepSeek Harness is an all-plugin Cordis agent harness. Read [docs/architecture.md](docs/architecture.md) before changing `packages/`; follow [docs/AGENTS.md](docs/AGENTS.md) for docs.
...
- Match evidence to the surface: focused behavior tests, model/user-output snapshots, `doc-sync`, built smokes for published paths, real-API e2e for providers.
...
- Markers: `FIXME`/`TODO`/`XXX` by urgency ([semantics](docs/development.md)).
