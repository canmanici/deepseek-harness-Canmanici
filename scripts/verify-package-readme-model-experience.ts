...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-mcp-library': { kind: 'none', reason: 'Browser-side MCP page; connected servers reach the model through dsh-mcp-client.' },
  'packages/client/ui-skill-library': { kind: 'none', reason: 'Browser-side Skills page; skill enablement reaches the model through dsh-skill-preferences.' },
  'packages/host/mcp-manager': { kind: 'none', reason: 'Remote management view; servers it adds reach the model through dsh-mcp-client.' },
  'packages/host/skill-manager': { kind: 'none', reason: 'Remote management view; writes go through dsh-skill-preferences and dsh-skill-sources, which own model effects.' },
  ...
  'packages/skill/skill-preferences': { kind: 'indirect', reason: 'The enablement filter removes disabled skills from the catalog that dsh-tool-skill renders.' },
  'packages/mcp/mcp-status': { kind: 'none', reason: 'Connection status serves management surfaces and never reaches a model request.' },
  'packages/skill/skill-marketplace': { kind: 'none', reason: 'Marketplace searches serve the Skills page; installs reach the model through dsh-skill-sources.' },
  'packages/skill/skill-sources': { kind: 'indirect', reason: 'The remote provider delegates model rendering to dsh-tool-skill.' },
