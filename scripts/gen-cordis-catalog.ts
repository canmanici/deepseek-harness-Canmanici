...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  skills: 'skills.md',
  skillPreferences: 'skills.md',
  skillSources: 'skills.md',
  skillMarketplace: 'skills.md',
  skillManager: 'skills.md',
  spillStore: 'spill.md',
  storage: 'storage.md',
...
export const EVENT_SCOPE_PAGE: Record<string, string> = {
  ...
  'settings': 'settings.md',
  'skills': 'skills.md',
  'skill-preferences': 'skills.md',
  'skill-sources': 'skills.md',
  'skill-manager': 'skills.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  SkillFilter: 'skills.md',
  SkillFilterControl: 'skills.md',
  SkillInventorySnapshot: 'skills.md',
  SkillPreferencesState: 'skills.md',
  SkillEnablementDecision: 'skills.md',
  SetSkillEnabledRequest: 'skills.md',
  ClearSkillOverrideRequest: 'skills.md',
  SkillSourceView: 'skills.md',
  AddSkillSourceRequest: 'skills.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  SkillDraft: 'skillManager wire types are owned by packages/host/skill-manager/src/types.ts',
  SkillNameRequest: 'skillManager wire types are owned by packages/host/skill-manager/src/types.ts',
  SkillDocumentValue: 'skillManager wire types are owned by packages/host/skill-manager/src/types.ts',
  SetSkillSourceEnabledRequest: 'skillManager wire types are owned by packages/host/skill-manager/src/types.ts',
  SkillInventoryRequest: 'skillManager wire types are owned by packages/host/skill-manager/src/types.ts',
  SkillInventoryValue: 'skillManager wire types are owned by packages/host/skill-manager/src/types.ts',
  SkillSourceRequest: 'skillManager wire types are owned by packages/host/skill-manager/src/types.ts',
  SkillSourcesValue: 'skillManager wire types are owned by packages/host/skill-manager/src/types.ts',
  SkillSourceValue: 'skillManager wire types are owned by packages/host/skill-manager/src/types.ts',
  InstallSkillRequest: 'skillManager wire types are owned by packages/host/skill-manager/src/types.ts',
  SkillMarketplacesRequest: 'skillManager wire types are owned by packages/host/skill-manager/src/types.ts',
  SkillMarketplacesValue: 'skillManager wire types are owned by packages/host/skill-manager/src/types.ts',
  SearchMarketplaceRequest: 'skillManager wire types are owned by packages/host/skill-manager/src/types.ts',
  SearchMarketplaceValue: 'skillManager wire types are owned by packages/host/skill-manager/src/types.ts',
  SetSkillSourceSkillsRequest: 'skillManager wire types are owned by packages/host/skill-manager/src/types.ts',
  SkillSourceSkillsValue: 'skillManager wire types are owned by packages/host/skill-manager/src/types.ts',
  MarketplaceView: 'skill marketplace types are owned by packages/skill/skill-marketplace/README.md',
  MarketplaceSearchRequest: 'skill marketplace types are owned by packages/skill/skill-marketplace/README.md',
  MarketplaceSearchResult: 'skill marketplace types are owned by packages/skill/skill-marketplace/README.md',
  SkillSourceOffer: 'skill source offers are owned by packages/skill/skill-sources/README.md',
  AddMcpServerRequest: 'mcpManager wire types are owned by packages/host/mcp-manager/src/types.ts',
  McpChangeValue: 'mcpManager wire types are owned by packages/host/mcp-manager/src/types.ts',
  McpServerRequest: 'mcpManager wire types are owned by packages/host/mcp-manager/src/types.ts',
  McpServersValue: 'mcpManager wire types are owned by packages/host/mcp-manager/src/types.ts',
  SearchMcpRegistryRequest: 'mcpManager wire types are owned by packages/host/mcp-manager/src/types.ts',
  SearchMcpRegistryValue: 'mcpManager wire types are owned by packages/host/mcp-manager/src/types.ts',
  SetMcpServerEnabledRequest: 'mcpManager wire types are owned by packages/host/mcp-manager/src/types.ts',
  McpServerStatus: 'MCP status types are owned by packages/mcp/mcp-status/README.md',
  McpStatusSource: 'MCP status types are owned by packages/mcp/mcp-status/README.md',
