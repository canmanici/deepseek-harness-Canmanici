...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  userPatchLayer: 'not a service: launcher-provided installation patch-layer facts (UserPatchLayerService | undefined) — packages/boot/app-boot/README.md owns the launcher contract',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  PluginPatchCommitted: 'event-local commit payload is owned by packages/host/plugin-inventory/src/types.ts',
