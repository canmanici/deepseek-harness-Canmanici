---
description: "共享核心、浏览器 GUI、一次性任务、ACP（Agent Client Protocol）、SDK 与可选外部能力的现成 dsh profile 组合包。"
kind: "package-group"
---
...
| [`open-design`](open-design/README.zh.md) | profile 智能体可选的 DSH 管理 OpenDesign 运行时、嵌入式 Studio 与工具 | `host-open-design`、`ui-open-design`、`mcp-open-design` |
