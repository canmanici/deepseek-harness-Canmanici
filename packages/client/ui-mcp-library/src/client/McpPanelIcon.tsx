/** The sidebar's MCP entry icon; the sidebar owns the button, label, and selected state around it. */
...
/**
 * Render the connector glyph at the size the sidebar asks for.
...
export function McpPanelIcon({ size }: PropsRuntime<'sidebar.panellist'>): ReactNode {
  return <IconLinkOutlineRegular size={size} />
}
